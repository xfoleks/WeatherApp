package edu.xfolex.weatherapp.presentation.viewmodel
...
import edu.xfolex.weatherapp.presentation.screen_state.WeatherState
    ...
    fun loadWeatherInfo() {
        viewModelScope.launch {
            ...
            locationTracker.getCurrentLocation()?.let { location ->
                ...
                state = state.copy(
                    isLoading = false,
                    error = "Coudln't retrieve location. make sure to grant permission and enable GPS."
                )
            }
        }
    }
